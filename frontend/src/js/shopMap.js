...
const objShopMap = [{
    ...
    {
        shopNmPos     : [
            {'shop_id' : '2001' ,'x': 20  ,'y': 180 , 'px' : 159  ,'py' : 118 ,'mapW' : 175 ,'mapH' : 50},
            {'shop_id' : '2002' ,'x': 470 ,'y': 380 , 'px' : -9   ,'py' : 45  ,'mapW' : 97 ,'mapH' : 50 },
            {'shop_id' : '2003' ,'x': 968 ,'y': 400 , 'px' : -220 ,'py' : 50  ,'mapW' : 135 ,'mapH' : 50},
