...
(function() {
    ...
    var ImgTouchCanvas = function(options) {
        ...
        this.markerPos = {}
        this.touchPos = {x : 0 ,y : 0 ,tempPosX : 0 , tempPosY : 0 ,startAngle : 0 ,currentAngle : 0 ,rotationAngle : 0}
        this.sTime     = 0
    ...
    ImgTouchCanvas.prototype = {
        animate: function(timestamp) {
            ...
            // this.context.rotate(this.touchPos.rotationAngle);
           ...
           // console.log('this.shopIdPos', this.shopNmArryPos)
            ...
            for(let i=0; i < this.shopNmArryPos.length; i++){
              ...
              //  console.log(areaX1 , 'selectedShop', areaY1)
                ...
                if( this.draggingEnd &&  (areaX1 <= calcX && areaX2 >= calcX && 
