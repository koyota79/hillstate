...
onMounted(() => {
    ...
    function drowCanvas(){  
        ...
        let drowPosX  = (parseInt(canvas.width/2) - start.tempX) //parseInt(canvas.width/2)
        let drowPosY  = (parseInt(canvas.height/2) - start.tempY)//parseInt(canvas.height/2)
    ...
    function fntouchmove(e){
        if(isDrag){  
            ...
            start.zoomX = e.touches[0].clientX
            start.zoomY = e.touches[0].clientY
            drowCanvas()
